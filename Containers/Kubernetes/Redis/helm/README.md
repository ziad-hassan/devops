...
# Get Master Name
kubectl get pods -n redis -o wide | grep `kubectl exec redis-0 -n redis -- redis-cli -h sentinel -p 5000 -a a-very-complex-password-here sentinel get-master-addr-by-name mymaster | head -n 1` | awk '{print $1}'
```
